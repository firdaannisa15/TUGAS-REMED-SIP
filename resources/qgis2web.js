...
map.getView().fit([12517239.899069, -893759.809778, 12541599.575696, -877263.732251], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PETA ANALISIS KESESUAIAN LAHAN RTH KOTA MALANG</h2>';
        return titleElement;
    })(),
